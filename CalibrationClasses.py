...
class Calibration:
    ...
    def sample_posterior(self,OBS_N,POST_L,POST_U,POST_N,SIM_POP_SIZE,TIME_STEPS,OBS_K,OBS_STDEV,NUM_SIM_COHORTS):
        """ sample the posterior distribution of the mortality probability """

        # find values of 5 year survival probability at which the posterior should be evaluated
        ...
        for cohort_id in self._cohortIDs:
            ...
            mean = multiCohort.get_cohort_5yearSurvivalPct(cohort_id)*OBS_N
...
class CalibratedModel:
    ...
    def simulate(self, cohort_size, time_steps,NUM_SIM_COHORTS):
        ...
        self._multiCohorts = SurvivalCls.MultiCohort(
            ids=resampled_ids,
            pop_sizes=[cohort_size] * NUM_SIM_COHORTS,
